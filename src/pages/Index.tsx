...
const TABS = ["Command", "Monitor", "Watchlist", "Layers", "Intelligence", "Scores", "Returns", "Holdings", "Transactions", "JISAs", "Earnings Calendar"] as const;
